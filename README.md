...
| Frame | bbox (x0, y0, x1, y1) |
|---|---|
| `00_idle.png` | (42, 400, 320, 1129) |
| `01_caminhada.png` | (0, 471, 320, 1120) |
| `02_corrida.png` | (0, 517, 320, 1108) |
| `03_aderencia_parede.png` | (0, 456, 320, 970) |
| `04_balanco_teia.png` | (0, 265, 320, 1129) |
...
1. Reexportar os frames com um pivô consistente (ex: pés sempre na mesma
   linha Y, personagem sempre centralizado horizontalmente no canvas).
2. Manter a hitbox fixa como está (ela já funciona pra colisão/gameplay) e
...
arte, vale considerar [Git LFS](https://git-lfs.com/) pros PNGs desde já
